package net.lldv.llamarewards.components.forms.custom;
...
import net.lldv.llamarewards.components.forms.FormHandler;
...
public class CustomForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(LlamaRewards.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
